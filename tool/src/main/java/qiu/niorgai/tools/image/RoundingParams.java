...
public class RoundingParams {
    ...
    public enum RoundingMethod {
         ...
         * {@link ScaleType#CENTER_CROP}, {@link ScaleType#FIT_XY}.
         *
         * If you use this rounding method with other scale types, such as
         * {@link ScaleType#CENTER}, you won't get an Exception but the image might look
         * wrong (e.g. repeated edges), especially in cases the source image is smaller than the view.
         */
        BITMAP_ONLY
    }

    private RoundingParams.RoundingMethod mRoundingMethod = RoundingParams.RoundingMethod.BITMAP_ONLY;
    ...
    public RoundingParams setOverlayColor(@ColorInt int overlayColor) {
        ...
        mRoundingMethod = RoundingParams.RoundingMethod.OVERLAY_COLOR;
        return this;
    }
